...
UPDATE entries
	SET title='Hemos venido a jugar',
  content='Hora de Kahoot2 !', date='2024-06-19', 
  id_author=(SELECT id_author FROM authors WHERE email='alvaru@thebridgeschool.es'), category='Software'
